...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='MPLinear')
    ...
    # data loader
    parser.add_argument('--data', type=str, required=True, default='weather', help='dataset type')
    ...
    # model define
    parser.add_argument('--top_k', type=int, default=1, help='for patching')
    ...
    parser.add_argument('--dropout1', type=float, default=0.3, help='dropout1')
    parser.add_argument('--stride', type=int, default=6, help='dropout')
    parser.add_argument('--conv_kernel', type=list, default=[21,23,25], help='conv_kernel')
    ...
    parser.add_argument('--patch_list', type=list, default=[], help='patch list')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_eb{}_dt{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
